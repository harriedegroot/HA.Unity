...
//        public List<HistoryList> GetHistory() => Get<List<HistoryList>>("/api/history/period");
...
//        public List<HistoryList> GetHistory(DateTimeOffset startDate) => Get<List<HistoryList>>($"/api/history/period/{startDate.UtcDateTime:yyyy-MM-dd\\THH:mm:ss\\+00\\:00}");
...
//        public List<HistoryList> GetHistory(DateTimeOffset startDate, DateTimeOffset endDate) => Get<List<HistoryList>>($"/api/history/period/{startDate.UtcDateTime:yyyy-MM-dd\\THH:mm:ss\\+00\\:00}?end_time={Uri.EscapeDataString(endDate.UtcDateTime.ToString("yyyy-MM-dd\\THH:mm:ss\\+00\\:00"))}");
...
//        public List<HistoryList> GetHistory(DateTimeOffset startDate, TimeSpan duration) => GetHistory(startDate, startDate.Add(duration));
...
//        public HistoryList GetHistory(string entityId, DateTimeOffset startDate, DateTimeOffset endDate) => (Get<List<HistoryList>>($"/api/history/period/{startDate.UtcDateTime:yyyy-MM-dd\\THH:mm:ss\\+00\\:00}?filter_entity_id={entityId}&end_time={Uri.EscapeDataString(endDate.UtcDateTime.ToString("yyyy-MM-dd\\THH:mm:ss\\+00\\:00"))}")).First();
...
//        public HistoryList GetHistory(string entityId) => (Get<List<HistoryList>>($"/api/history/period?filter_entity_id={entityId}")).First();
//    }
//}
